...
class TestVectorizationPipelineIntegration:
    def test_ingest_chunk_vectorize_and_query(self, fixtures_dir: Path, tmp_path: Path) -> None:
        ...
        assert top_result.provenance.source_path == str(fixtures_dir / "legal_contract.docx")
